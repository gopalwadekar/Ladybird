...
public class Constants {
	...
	public static String rootEmailFlag = "";
	public static String rootDB_InsFlag = "";
	...
	public static List<WebElement> listTableData = null;
	public static List<WebElement> notelistDivs = null;
	public static List<WebElement> tasklistDivs = null;
	public static List<String> notelistRowItems = new ArrayList<String>();
	public static List<String> tasklistRowItems = new ArrayList<String>();
	public static List<String> readGridDataList = new ArrayList<String>();

	
//	;
//	database=;
//	user=automation-db-user@c3ius48834;
...
//		database=Automation;user=;
//		password={your_password_here};
//		encrypt=true;
//		hostNameInCertificate=*.database.windows.net;loginTimeout=30;
	
	public static String conStringAutomation = "jdbc:sqlserver://c3ius48834.database.secure.windows.net:1433;"
			+ "database=Automation;"
			+ "user=automation-db-user@c3ius48834;"
